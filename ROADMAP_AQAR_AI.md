...
| 4b | Short-term booking — frontend | Not started | — | Depends on 4a (done). Read: `backend/app/api/routes/bookings.py`, `backend/app/models/area_intelligence.py`, `backend/app/api/routes/ai.py`. Build calendar UI + AI dynamic pricing/availability assistant per Prompt 9 in SESSION_PROMPTS.md. |
