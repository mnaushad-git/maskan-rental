          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="rounded-2xl border border-border bg-card p-5 shadow-card space-y-3">
              ...
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-whatsapp py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90"
              >
              ...
              <EmptyState
                ...
                action={
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl bg-whatsapp px-4 py-2 text-sm font-semibold text-white"
                  >
